...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        len_letters = len(lower)
        shift_dict = {}
        for i in range(len_letters):
            shift_dict[lower[i]] = lower[(i+shift)%len_letters]
            shift_dict[upper[i]] = upper[(i+shift)%len_letters]
        return shift_dict
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(0, -26, -1):
            ...
            #print('this is the message list {}'.format(message_list))
            ...
            if sum > max_words:
                ...
                max_shift = shift
                decrypt = new_message
        return ((26+max_shift)%26, decrypt)
